...
const _CONFIG = (
	{
		...
		EntrypointInputSourceFile: `${__dirname}/index.js`,
...
//		LibraryUniminifiedFileName: `find-my-way.js`,
		LibraryUniminifiedFileName: `find-my-way-nomock.js`,

		// The name of the minified version of the packaged library, for production release:
//		LibraryMinifiedFileName: `find-my-way.min.js`
		LibraryMinifiedFileName: `find-my-way-nomock.min.js`
	});
